...
const ProfileOptions = () => {
  ...
  // State to track selected genre
  const [selectedGenre, setSelectedGenre] = useState("All");
  // State to track if mobile sidebar is open
  const [mobileSidebarOpen, setMobileSidebarOpen] = useState(false);
  // State to track profile dropdown visibility
  ...
  const toggleProfileDropdown = () => {
    ...
    // On mobile, prevent background scrolling when modal is open
    if (isMobile) {
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="md:hidden border-t border-gray-200 fixed bottom-0 w-full bg-white z-40">
      ...
      {/* Mobile Profile Modal - Displayed above bottom nav */}
      {/* Mobile Profile Modal - Full screen with higher z-index than bottom nav */}
      {showProfileDropdown && isMobile && (
        <>
          {/* Overlay */}
          <div
          ...
          {/* Modal */}
          <div
            className="fixed inset-x-0 top-1.5/4 bottom-0 rounded-t-lg bg-white shadow-md z-50"
            style={{
              fontFamily: "Helvetica Neue",
              fontWeight: 500,
              fontSize: "14px",
            ...
            <div className="p-4">
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center p-3 hover:bg-gray-100 rounded-md">
                  <img src={switchIcon} alt="Switch" className="w-5 h-5 mr-3" />
                  Switch to Studio
                </button>
